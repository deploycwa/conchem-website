...
const variantInnerStyles: Record<ProductImageVariant, string> = {
  card: "rounded-[1rem] border border-dashed border-[#D1D5DB] bg-white p-4",
  featured: "rounded-[1.5rem] border border-dashed border-[#D1D5DB] bg-white px-6 py-14",
  detail: "rounded-[1.5rem] border border-dashed border-[#CBD5E1] bg-white px-6 py-16",
};
